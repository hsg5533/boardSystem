        ...
        <tr>
          ...
          <td>
            <a
              ...
              >${board.title}(${board.replycount})</a
            >
          </td>
          <td>${board.writer}</td>
          <td>
  ...
  <div class="d-flex justify-content-between mt-3">
    ...
    <form class="form-inline" action="/board/list" id="searchFrm">
      <select name="field" class="form-control mb-2 mr-sm-2">
        ...
        value="writer" ${ field=='writer' ? 'selected' : '' }>내용 <option
        value="content" ${ (field=='content') ? 'selected' : '' }>작성자 <option
        value="cwt" ${ (field=='cwt') ? 'selected' : '' }>제목or내용or작성자
      </select>
      <input
        type="text"
